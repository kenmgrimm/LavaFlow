...
////// Emissive:
                ...
                float3 node_2641 = ((i.vertexColor.rgb*lerp( _MainTex_var.rgb, dot(_MainTex_var.rgb,float3(0.3,0.59,0.11)), _Desaturate )*_Emission*_MainTex_var.a*i.vertexColor.a)*node_2644);
                float3 emissive = node_2641;
                float3 finalColor = emissive;
                float node_7883 = (((_MainTex_var.a*i.vertexColor.a)*node_2644)*saturate((sceneZ-partZ)/_Depth));
