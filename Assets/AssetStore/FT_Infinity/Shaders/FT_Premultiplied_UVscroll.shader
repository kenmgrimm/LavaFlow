...
////// Emissive:
                ...
                float3 emissive = (lerp(float3(node_5158,node_5158,node_5158),((i.vertexColor.rgb*lerp( _MainTex_var.rgb, dot(_MainTex_var.rgb,float3(0.3,0.59,0.11)), _Desaturate )*_Emission*_MainTex_var.a*i.vertexColor.a)*node_2644),_FresnelInvert_var)*_DoubleSide_var);
                float3 finalColor = emissive;
                fixed4 finalRGBA = fixed4(finalColor,(lerp(node_5158,(((_MainTex_var.a*i.vertexColor.a)*node_2644)*saturate((sceneZ-partZ)/_Depth)),_FresnelInvert_var)*_DoubleSide_var));
